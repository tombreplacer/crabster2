...
complete -c crabster -n "__fish_crabster_needs_command" -f -a "start" -d 'Start the file server (default)'
...
complete -c crabster -n "__fish_crabster_using_subcommand start" -s h -l help -d 'Print help'
...
complete -c crabster -n "__fish_crabster_using_subcommand help; and not __fish_seen_subcommand_from start ps stop help" -f -a "start" -d 'Start the file server (default)'
complete -c crabster -n "__fish_crabster_using_subcommand help; and not __fish_seen_subcommand_from start ps stop help" -f -a "ps" -d 'List running daemon instances'
complete -c crabster -n "__fish_crabster_using_subcommand help; and not __fish_seen_subcommand_from start ps stop help" -f -a "stop" -d 'Stop a running daemon instance'
complete -c crabster -n "__fish_crabster_using_subcommand help; and not __fish_seen_subcommand_from start ps stop help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
